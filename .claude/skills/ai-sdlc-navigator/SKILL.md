...
- D: use [the owning Python entry point](scripts/navigate.py) with explicit inputs; success covers only executed checks.
- S: interpret sources for Read-only Markdown or TOON navigation report; cite unresolved decisions.
