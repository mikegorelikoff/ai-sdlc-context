...
Rows represent individual story id records. Show the user decision before detail; preserve source order and explicit authority.
Summary: Status / Decision / Evidence. Failure: Accepted workflow / Status / Blocker / Evidence / Required action.
Clarification: Missing accepted workflow / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
