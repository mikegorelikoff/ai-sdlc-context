...
Rows represent individual action records. Show unresolved blockers before nonblocking findings; a completed review is not delivery approval.
Summary: Status / Decision / Evidence. Failure: Policy layer / Status / Blocker / Evidence / Required action.
Clarification: Missing policy layer / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
