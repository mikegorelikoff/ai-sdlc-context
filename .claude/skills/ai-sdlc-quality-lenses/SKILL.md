...
Rows represent individual lens records. Show unresolved blockers before nonblocking findings; a completed review is not delivery approval.
Summary: Status / Decision / Evidence. Failure: Review artifact / Status / Blocker / Evidence / Required action.
Clarification: Missing review artifact / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
