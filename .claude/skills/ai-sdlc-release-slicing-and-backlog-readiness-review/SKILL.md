...
Rows represent individual release slice records. Show the user decision before detail; preserve source order and explicit authority.
Summary: Status / Decision / Evidence. Failure: Release constraint / Status / Blocker / Evidence / Required action.
Clarification: Missing release constraint / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
