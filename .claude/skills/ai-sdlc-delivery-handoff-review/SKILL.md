...
Rows represent individual delivery gate records. Show unresolved blockers before nonblocking findings; a completed review is not delivery approval.
Summary: Status / Decision / Evidence. Failure: Delivery package / Status / Blocker / Evidence / Required action.
Clarification: Missing delivery package / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
