...
Rows represent individual operation records. Show the user decision before detail; preserve source order and explicit authority.
Summary: Status / Decision / Evidence. Failure: Host capability / Status / Blocker / Evidence / Required action.
Clarification: Missing host capability / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
