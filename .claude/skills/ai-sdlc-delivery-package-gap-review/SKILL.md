...
Rows represent individual workflow records. Show unresolved blockers before nonblocking findings; a completed review is not delivery approval.
Summary: Status / Decision / Evidence. Failure: Workflow rule / Status / Blocker / Evidence / Required action.
Clarification: Missing workflow rule / Why required / Known evidence / Options. Next action: Owner / Next action / Expected evidence.
