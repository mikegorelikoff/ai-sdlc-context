...
| Missing changed reference | Why required | Known evidence | Options |
| --- | --- | --- | --- |
| Changed reference | Determines changed reference | No supported assumption | Supply source / narrow requested scope |
