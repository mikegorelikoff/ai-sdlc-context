...
| Missing package manifest | Why required | Known evidence | Options |
| --- | --- | --- | --- |
| Package manifest | Determines control | No supported assumption | Supply source / narrow requested scope |
