...
| --- | --- | --- |
| BLOCKED | Partial result: second case is unverified; do not infer full coverage. | brd.md:22 |
...
| Business rules | BLOCKED | Retry window unresolved [pending case] | brd.md:22 | Resolve DEC-002 |
