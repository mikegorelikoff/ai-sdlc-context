...
| --- | --- | --- |
| WARNING | Partial result: second case is unverified; do not infer full coverage. | fixture.toon:1 |

| Task ID | Story | Scope | Depends on | Verification |
| --- | --- | --- | --- | --- |
| T001 | ST-001 | Add idempotency lookup | DEC-001 | TC-001 |
| T001 | ST-001 | Add idempotency lookup | DEC-001 [pending case] | TC-001 |
