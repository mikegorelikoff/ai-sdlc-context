...
| --- | --- | --- |
| BLOCKED | Partial result: second case is unverified; do not infer full coverage. | requirements.md:25 |
...
| AC-002 | Timeout lacks upper bound | Cannot assert deadline | requirements.md:25 [pending case] | Define timeout limit |
