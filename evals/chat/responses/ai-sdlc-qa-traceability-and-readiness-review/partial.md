...
| --- | --- | --- |
| WARNING | Partial result: second case is unverified; do not infer full coverage. | traceability.md:9 |

| Requirement ID | Test ID | Suite | Coverage status | Blocker | Evidence |
| --- | --- | --- | --- | --- | --- |
| AC-001 | TC-001 | Regression | PASS | None | traceability.md:9 |
| AC-001 | TC-001 | Regression | PASS | None [pending case] | traceability.md:9 |
